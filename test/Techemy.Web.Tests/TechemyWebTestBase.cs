...
{
    public abstract class TechemyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TechemyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TechemyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TechemyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TechemyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TechemyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TechemyDbContext, Task<T>> func)
        {
            T result;
